...
/* CTRVPlaceBundle::menuPlace.html.twig */
class __TwigTemplate_09e07a591e6451d07bb844ae2714b120 extends Twig_Template
{
...
\t\t<li><a class=\"btn btn-block\" href=\"";
        ...
        echo "\">";
        echo $this->env->getExtension('translator')->getTranslator()->trans("place.menu.moderateAll", array(), "messages");
        echo "</a></li>
\t\t<li><a class=\"btn btn-block\" href=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("placeComment"), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('translator')->getTranslator()->trans("placeComment.menu.afficher", array(), "messages");
        echo "</a></li>
\t\t<li><a class=\"btn btn-block\" href=\"";
        // line 7
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("rechercher_place"), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('translator')->getTranslator()->trans("place.menu.search", array(), "messages");
        echo "</a></li>
\t\t<li><a class=\"btn btn-block\" href=\"";
        // line 8
...
\t\t<li><a class=\"btn btn-block\" href=\"";
        // line 9
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("loadTypePlaces"), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('translator')->getTranslator()->trans("place.menu.type", array(), "messages");
        echo "</a></li>
\t\t<li><a class=\"btn btn-block\" href=\"";
        // line 10
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("placeWithoutLatLong"), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('translator')->getTranslator()->trans("place.menu.setLatLng", array(), "messages");
        echo "</a></li>
\t\t<li><a class=\"btn btn-block\" href=\"";
        // line 11
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("placeWithoutDescription"), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('translator')->getTranslator()->trans("place.menu.setPlaceDescription", array(), "messages");
        echo "</a></li>
\t\t<li><a class=\"btn btn-block\" href=\"";
        // line 12
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("placeWithSameAddress"), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('translator')->getTranslator()->trans("place.menu.placeWithSameAddress", array(), "messages");
        echo "</a></li>
\t\t<li><a class=\"btn btn-block\" href=\"";
        // line 13
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("delete_double"), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('translator')->getTranslator()->trans("place.menu.show_delete_double", array(), "messages");
        echo "</a></li>
\t</ul>
</div>";
    }
    ...
    {
        return "CTRVPlaceBundle::menuPlace.html.twig";
    }
